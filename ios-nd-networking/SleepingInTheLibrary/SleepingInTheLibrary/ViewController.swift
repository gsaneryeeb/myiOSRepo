...
class ViewController: UIViewController {
    ...
    private func getImageFromFlickr() {
        ...
        let task = URLSession.shared.dataTask(with: request){(data,response,error) in
            ...
            // if an error occurs,print it and re-enalbe the UI
            ...
            do{
                ...
                stat == Constants.FlickrResponseValues.OKStatus else {
                    displayError("Flickr API returned an error. See error code and message in \(parsedResult)")
                    return
                }
                
                /* GUARD: Are the "photos" and "photo" keys in our result? */
                guard let photosDictionary = parsedResult[Constants.FlickrResponseKeys.Photos]
                    as? [String: AnyObject], let photoArray = photosDictionary[Constants.FlickrResponseKeys.Photo]
                ...
                guard let imageUrlString = photoDictionary[Constants.FlickrResponseKeys.MediumURL]
                    as? String else{
    ...
    private func escapedParameters(parameters:[String:AnyObject]) -> String{
        /*
         ...
         //?course=networking&quiz=escaping%20parameters&nanodegree=ios
         */
